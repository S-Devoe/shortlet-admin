      ...
      <section className="">
        <div className="">
          ...
          <p className="w-full text-base font-normal text-black-two-three mt-8 mb-4">
            My caution fee wasn’t refunded after I checked out, I really want to
            know why it wasn’t refunded. I have attached an image of the
            screenshot of my reservation details.
          </p>
        </div>
        <div className="">
