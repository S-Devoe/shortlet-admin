...
const listingData = dataSource.listing;
const balances = [
  {
    text: "Total Balance",
    amount: 20323,
...
export default function HostPage({ params }: { params: { id: string } }) {
  return (
    <main className="flex overflow-hidden min-h-full flex-col">
      <section className="flex flex-col gap-4 md:flex-row justify-between md:items-center">
      ...
      <section className="mt-6 hidden md:block">
        ...
        <Link href={`/host/${params.id}/transactions`}>
          <Button
            className="mt-6 !w-full md:!w-auto md:mt-8"
            text={"View all host transactions"}
            width="large"
            height="medium"
          />
        </Link>
      ...
      <section className="block md:hidden mt-4">
        <Tabs isFitted isLazy variant={"unstyled"}>
          <TabList
            ...
            fontSize={"16px"}
          >
            <Tab _selected={{ color: "#FF5626" }}>Listings</Tab>
              ...
              <div className="flex flex-col mt-[10px] gap-4">
                {Array(3)
                  ...
                  .map((row, idx) => (
                    <div
                      key={idx}
                      className="bg-gray-eleven p-4 flex items-center gap-6 rounded-2xl"
                    >
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <Text
                          ...
                          className="flex items-center gap-0.5"
                        >
                          {row.guests} Guests {row.bedrooms} Bedrooms
                        </Text>
                      </div>
                    </div>
                  ))}
